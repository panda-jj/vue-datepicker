<script>
    ...
    exports.default = {
        ...
        computed: {
            selectingType: {
                set (val) {
                    this.option.type = val ? 'day' : 'week-picker'
                },
                get () {
                    return this.option.type === 'day'
                }
            }
        },
        methods: {
...
<template>
    <div class="cov-vue-date">
        ...
        <i v-if="option.element == 'image'" :style="option.inputStyle" @click="showCheck"
           class="datepickimage material-icons input-field">today</i>
        <!-- MODAL LAYOUT -->
    ...
    'background' : option.overlayOpacity? 'rgba(0,0,0,'+option.overlayOpacity+')' : 'rgba(0,0,0,0.5)'
        ...
        'background-color': option.color ? option.color.header : '#3f51b5'
              ...
              'passive-day': !(day.inMonth)
                ...
                <div class="switch-toggler" v-if="option.switch">
                    <md-switch :value.sync="selectingType">
                        <span slot="on">Day</span>
                        <span slot="off">Week</span>
                    </md-switch>
                </div>
...
<style>
    ...
    .switch-toggler .switch {
        text-align: center;
    }

    .switch-toggler .switch > label {
        position: static;
    }
